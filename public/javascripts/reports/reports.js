		...
		$.get('/reports/total_adoptions_by_type_and_month', 
			function(data) {
				var options = {
				    ...
				    title: { text: 'Monthly Adoptions by Type - ' + titleDate },
				    xAxis: {
				...
				$.each(data, function(i, item) {
					...
					series.data = [item.jan,item.feb,item.mar,item.apr,item.may,item.jun,item.jul,item.aug,item.sept,item.oct,item.nov,item.dec];
