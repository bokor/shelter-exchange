class Api::AnimalsController < Api::ApplicationController
  ...
  def configure
    ...
    raise ShelterExchange::Errors::ApiIncorrectTypeStatus if @statuses.include?(AnimalStatus::STATUSES[:deceased]) or @statuses.include?(AnimalStatus::STATUSES[:euthanized])
  end
  ...
  rescue_from ShelterExchange::Errors::ApiIncorrectTypeStatus do |exception|
