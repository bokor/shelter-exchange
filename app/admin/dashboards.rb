ActiveAdmin::Dashboards.build do
  ...
  section "Animal Status Totals", :priority => 1 do
    table_for Animal.unscoped.includes(:animal_status).group("animal_statuses.name").limit(nil).count do
      column("Status") { |status, count| status.to_s } 
