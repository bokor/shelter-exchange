...
ActiveRecord::Schema.define(:version => 20101224163250) do
  ...
  add_index "floorplans", ["animal_type_id"], :name => "index_floorplans_on_animal_type_id"
  add_index "floorplans", ["shelter_id"], :name => "index_floorplans_on_shelter_id"
