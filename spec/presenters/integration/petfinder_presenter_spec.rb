...
describe Integration::PetfinderPresenter do
  ...
  describe "#description" do
    ...
    it "returns generic description when blank" do
      ...
      presenter = Integration::PetfinderPresenter.new(@animal)
      expect(presenter.description).to eq("<p>No description provided<br><br>#{@animal.name}, #{@animal.full_breed} has been shared from Shelter Exchange - http://www.shelterexchange.org.</p>")
    end

    it "returns formatted description" do
      @animal.update_column(:description, "this is cool.  www.example.org")
      presenter = Integration::PetfinderPresenter.new(@animal)
      expect(presenter.description).to eq("<p>this is cool.  www.example.org<br><br>#{@animal.name}, #{@animal.full_breed} has been shared from Shelter Exchange - http://www.shelterexchange.org.</p>")
    end

    it "returns formatted description with carriage returns" do
      @animal.update_column(:description, "hi\n bye\n\r")
      presenter = Integration::PetfinderPresenter.new(@animal)
      expect(presenter.description).to eq("<p>hi<br><br /> bye</p><br><br><p><br><br>#{@animal.name}, #{@animal.full_breed} has been shared from Shelter Exchange - http://www.shelterexchange.org.</p>")
    end
  end
