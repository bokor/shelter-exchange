...
describe ApplicationController do
  ...
  context "with user logged in" do
    ...
    it "sets current layout" do
      pending
      get :index
      puts controller.current_shelter == current_shelter
      expect(response).to render_template(:layout => "app/application")
    end
  end
  ...
  context "with user logged out" do
    it "sets current layout" do
      pending
      get :index
      expect(response).to render_template(:layout => "app/login")
    end
  end
end
