...
describe Shelter do
  ...
  it "validates uniqueness of email" do
    ...
    expect(shelter.error_on(:email).size).to eq(1)
  ...
  it "validates inclusion of timezone" do
    ...
    expect(shelter.error_on(:time_zone).size).to eq(1)
    ...
    expect(shelter.error_on(:time_zone).size).to eq(0)
  end

  it "validates url format for website" do
    shelter = Shelter.new :website => "save-the_doggies.com"
    expect(shelter.error_on(:website).size).to eq(1)
  ...
  it "validates allows blank for website" do
    ...
    expect(shelter.error_on(:website).size).to eq(0)
  end

  it "validates url format for facebook" do
    shelter = Shelter.new :facebook => "facebook.com/test"
    expect(shelter.error_on(:facebook).size).to eq(1)
  ...
  it "validates allows blank for facebook" do
    ...
    expect(shelter.error_on(:facebook).size).to eq(0)
  end

  it "validates twitter format for twitter" do
    shelter = Shelter.new :twitter => "savethedoggies"
    expect(shelter.error_on(:twitter).size).to eq(1)
  ...
  it "validates allows blank for twitter" do
    ...
    expect(shelter.error_on(:twitter).size).to eq(0)
  end
  ...
  it "validates uniqueness of access token" do
    ...
    expect(shelter.error_on(:access_token).size).to eq(1)
  ...
  it "validates allows blank for access_token" do
    ...
    expect(shelter.error_on(:access_token).size).to eq(0)
  end
